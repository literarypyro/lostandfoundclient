...
<section class="bg-gray-100 min-h-screen flex box-border justify-center items-center">
    <div class="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
            ...
            <form @submit.prevent="loginUser" action="" class="flex flex-col gap-4">


            


                <input class="p-2 mt-8 rounded-xl border" placeholder="Username" type="text" v-model="username" name="username" />
                <div class="relative">

                    <input class="p-2 rounded-xl border w-full"  placeholder="password" type="password" v-model="password" name="password"/>
            ...
            <div class="mt-4 text-sm flex justify-between items-center container-mr">
                ...
                <button @click="registerAccount" class="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Register</button>
            </div>
        </div>
